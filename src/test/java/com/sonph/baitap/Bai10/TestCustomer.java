...
public class TestCustomer extends BaseTest{
    ...
    @Test(priority = 3)
    public void testDeleteCustomer(String cusName)throws InterruptedException{
        ...
        driver.findElement(By.xpath(LocatorsCRM.inputSearchCustomer)).sendKeys(cusName);
        Thread.sleep(2000);
        Actions actions = new Actions(driver);
        WebElement firstRow = driver.findElement(By.xpath(LocatorsCRM.firstRowCustomerTable));
        actions.moveToElement(firstRow).perform();

        driver.findElement(By.xpath(LocatorsCRM.btnDeleteCustomer)).click();
        Alert alert = driver.switchTo().alert();
        alert.accept();
        Thread.sleep(2000);
        Assert.assertEquals(driver.findElement(By.xpath(LocatorsCRM.alertDeleteCustomerSuccess)).getText(),"Customer deleted","Customer deleted successfully");
    }

    @Parameters(value = {"cusName"})
    @Test(priority = 2)
    public void testSearchCustomer(String cusName)throws InterruptedException{
        driver.findElement(By.xpath(LocatorsCRM.menuCustomer)).click();
        driver.findElement(By.xpath(LocatorsCRM.inputSearchCustomer)).clear();
        driver.findElement(By.xpath(LocatorsCRM.inputSearchCustomer)).sendKeys(cusName);
        Thread.sleep(2000);
        ...
        Assert.assertTrue(comapyNameAddNew.contains(cusName),"Customer new is correct!");
    }
    ...
    public void addNewCustomer(String cusName) throws InterruptedException {
        ...
        String comapyNameAddNew = driver.findElement(By.xpath(LocatorsCRM.firstRowCustomerTable)).getText();
        Assert.assertEquals(comapyNameAddNew, customerName,"Customer new is correct!");
    }
